package com.recipe.r.ui.adapter.head;
...
public class GirdDropDownAdapter extends BaseAdapter {
    ...
    public GirdDropDownAdapter(Context context, ArrayList<String> list) {
    ...
    static class ViewHolder {
        ...
        ViewHolder(View view) {
            mText= (TextView) view.findViewById(R.id.text_list_drop_down);
