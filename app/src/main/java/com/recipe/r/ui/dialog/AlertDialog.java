...
public class AlertDialog {
    ...
    public AlertDialog builder() {
        ...
        View view = LayoutInflater.from(context).inflate(
                R.layout.dialog_alertdialog2, null);
        // 获取自定义Dialog布局中的控件
    ...
    public AlertDialog setTitleColor(int textcolor) {
    ...
    public AlertDialog setMsgColor(int textcolor) {
        txt_msg.setTextColor(textcolor);
        return this;
    }
