...
public class ModifyAddressActivity extends BaseActivity {
    ...
    private Context context = ModifyAddressActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        detailAddr = getIntent().getExtras().getString("detailAddr");
        code = getIntent().getExtras().getString("code");
        isDefault = getIntent().getExtras().getInt("isDefault");
        receiverName = getIntent().getExtras().getString("receiverName");
        receiverPhone = getIntent().getExtras().getString("receiverPhone");
        receiverAddrId = getIntent().getExtras().getString("receiverAddrId");
        initHead(R.mipmap.reset_back, "返回", "编辑地址", 0, "");
        initView();
        initData();
        initListener();
    }
    ...
    private void initView() {
        ...
        commit_address = (Button) findViewById(R.id.commit_address);
        region_editaddress = (TextView) findViewById(R.id.region_editaddress);
        default_address = (ToggleButton) findViewById(R.id.default_address);
        code_editaddress.setText(code);
        address_editaddress.setText(detailAddr);
        region_editaddress.setText("省份");
        nickname_editaddress.setText(receiverName);
        phone_editaddress.setText(receiverPhone);
        if (isDefault == 0) {
        ...
        area_editaddress.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (isLoaded) {
                    ...
                    Toast.makeText(ModifyAddressActivity.this, "暂未获取到城市数据，请稍等", Toast.LENGTH_SHORT).show();
                }
            }
        });
        commit_address.setOnClickListener(new OnClickListener() {
...
//        String code = code_editaddress.getText().toString();
        ...
        params.put("address_id", receiverAddrId);
                ...
                .enqueue(new JsonResponseHandler() {
                    ...
                    public void onSuccess(int statusCode, JSONObject response) {
                        ...
                        try {
                            ...
                            ToastUtil.show(ModifyAddressActivity.this, info, 500);
                            if (status == 1) {
                                ModifyAddressActivity.this.finish();
                            }
