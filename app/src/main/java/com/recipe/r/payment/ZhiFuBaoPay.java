...
public class ZhiFuBaoPay {
    ...
    public ZhiFuBaoPay(Activity context) {
     ...
     * @param order_sn
     */
    public void payAliBaba(int i, String type, String order_sn) {
    ...
    private void payZFB(String orderinfo_str) {
        ...
        params.put("out_trade_no", orderinfo_str);
