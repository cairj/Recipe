...
//	public static final String RSA_PRIVATE = "";
    ...
    public void payV2(View v) {
        if (TextUtils.isEmpty(ConfigApp.APPID) || (TextUtils.isEmpty(ConfigApp.RSA2_PRIVATE) && TextUtils.isEmpty(ConfigApp.RSA_PRIVATE))) {
         ...
         * orderInfo的获取必须来自服务端；
         */
        boolean rsa2 = (ConfigApp.RSA2_PRIVATE.length() > 0);
        Map<String, String> params = OrderInfoUtil2_0.buildOrderParamMap(ConfigApp.APPID, rsa2);
        String orderParam = OrderInfoUtil2_0.buildOrderParam(params);

        String privateKey = rsa2 ? ConfigApp.RSA2_PRIVATE : ConfigApp.RSA_PRIVATE;
    ...
    public void authV2(View v) {
        if (TextUtils.isEmpty(ConfigApp.PID) || TextUtils.isEmpty(ConfigApp.APPID)
                || (TextUtils.isEmpty(ConfigApp.RSA2_PRIVATE) && TextUtils.isEmpty(ConfigApp.RSA_PRIVATE))
                || TextUtils.isEmpty(ConfigApp.TARGET_ID)) {
         ...
         */
        boolean rsa2 = (ConfigApp.RSA2_PRIVATE.length() > 0);
        Map<String, String> authInfoMap = OrderInfoUtil2_0.buildAuthInfoMap(ConfigApp.PID, ConfigApp.APPID, ConfigApp.TARGET_ID, rsa2);
